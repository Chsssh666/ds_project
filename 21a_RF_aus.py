...
# %% Data
X_train = pd.read_csv("./data/X_train_model_1a_aus.csv")
X_test = pd.read_csv("./data/X_test_model_1a_aus.csv")
y_train = pd.read_csv("./data/y_train_model_1a_aus.csv")
y_test = pd.read_csv("./data/y_test_model_1a_aus.csv")
...
plt.savefig("./figures/aus_model1a_random_forest_feature_importance.png", bbox_inches="tight")
plt.show()
...
plt.gca().invert_yaxis()
plt.savefig("./figures/aus_model1a_random_forest_non_state_feature_importance.png", bbox_inches="tight")
plt.show()
# %%
