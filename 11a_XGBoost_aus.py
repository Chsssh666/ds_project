...
plt.savefig("./figures/aus_model1a_xgboost_feature_importance.png", bbox_inches="tight")
plt.show()
...
plt.gca().invert_yaxis()
plt.savefig("./figures/aus_model1a_xgboost_non_state_feature_importance.png", bbox_inches="tight")
plt.show()
