...
plt.savefig("./figures/aus_model1b_random_forest_feature_importance.png", bbox_inches="tight")
plt.show()
...
plt.gca().invert_yaxis()
plt.savefig("./figures/aus_model1b_random_forest_non_state_feature_importance.png", bbox_inches="tight")
plt.show()
# %%
